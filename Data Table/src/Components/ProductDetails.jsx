...
const ProductDetails = () => {
  ...
  return (
    <div style={{ textAlign: "center"}}>
      ...
      <Link onClick={handleDelete} to={`/Deleteproduct/${product.id}`} style={{ marginRight: "10px",backgroundColor:"grey",padding:"7px 27px",borderRadius:"5px",color:"white" ,textDecoration:"none"}}>
        Delete
      </Link>
      <br /><br />
